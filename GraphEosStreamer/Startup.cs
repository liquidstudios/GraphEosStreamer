    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddHostedService<DeltaMergerService>()
                ...
                .AddSingleton(Channel.CreateUnbounded<DeserializedGetBlocksResultV0>(new UnboundedChannelOptions() { SingleReader = false, SingleWriter = false}))
                ...
                .AddSingleton(svc => svc.GetRequiredService<Channel<DeserializedGetBlocksResultV0>>().Reader)
                .AddSingleton(svc => svc.GetRequiredService<Channel<DeserializedGetBlocksResultV0>>().Writer)
