...
namespace EosSharp.Core
{
    ...
    {
        /// <summary>
        /// http or https location of a nodeosd server to push transactions, leave blank to use HttpEndpoint to push transactions.
        /// </summary>
        public string HttpPushEndpoint { get; set; }

        /// <summary>
        /// http or https location of a nodeosd server providing a chain API, if PushHttpEndpoint set,HttpEndpoint is only used to read data.
        /// </summary>
